...
;(function(factory) {
    ...
    // 构造视图DOM模板
    var reportLossListDomTemplate = '<a class="atm-btn btn-left btn-row-4" data-bind="click: prevPage">返&nbsp;&nbsp;回</a>\
    ...
    <a class="atm-btn btn-right btn-row-4 btn-confirm" data-bind="click: queryRelativeAssets">查看签约账户</a>\
