...
;(function(factory) {
    ...
    // 构造视图DOM模板
    var reportLossAssetDomTemplate = '<a class="atm-btn btn-right btn-row-1" data-bind="click: rowMoveUp"><i class="fa fa-arrow-up"></i></a>\
    <a class="atm-btn btn-right btn-row-2" data-bind="click: rowMoveDown"><i class="fa fa-arrow-down"></i></a>\
    <a class="atm-btn btn-right btn-row-4 btn-confirm" data-bind="click: checkinfo">\
      <span class="zh-CN">挂失</span>\
      <span class="en-US">Report Loss</span>\
    </a>\
...
\
      <div class="text">\
        <div class="zh-CN">请使用<b>[↑] [↓]</b>键选择账户<br>按<b>[挂失]</b>键继续</div>\
        <div class="en-US">Please use <b>[↑] [↓]</b> to select the account,<br> then press <b>[Report Loss]</b> to continue.</div>\
      </div>\
    </div>';
